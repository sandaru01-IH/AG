...
-- ============================================
-- STEP 3: Create new users table policies (NO RECURSION)
-- ============================================
...
-- Policy 2: Co-founders can view all users (uses function to avoid recursion)
CREATE POLICY "Co-founders can view all users" ON public.users
  FOR SELECT USING (public.is_user_co_founder());

-- ============================================
-- STEP 4: Fix all other policies that reference users table
-- ============================================
...
-- VERIFICATION
-- ============================================
-- After running this, the recursion error should be gone
-- Test by visiting /dashboard/debug page
